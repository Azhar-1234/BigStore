<a href="offer.html"><img src="{{'fontend/assets'}}/images/download.png" class="img-head" alt=""></a>
<div class="header">
	<div class="container">
		<div class="logo">
							...
							<ul class="dropdown-menu multi">
								<div class="row">
									...
									<div class="col-sm-3 w3l">
										<a href="kitchen.html"><img src="{{'fontend/assets'}}/images/me.png" class="img-responsive" alt=""></a>
									</div>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu multi multi1">
								<div class="row">
									...
									<div class="col-sm-3 w3l">
										<a href="care.html"><img src="{{'fontend/assets'}}/images/me1.png" class="img-responsive" alt=""></a>
									</div>
									<div class="clearfix"></div>
								</div>	
							</ul>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu multi multi2">
								<div class="row">
									...
									<div class="col-sm-3 w3l">
										<a href="hold.html"><img src="{{'fontend/assets'}}/images/me2.png" class="img-responsive" alt=""></a>
									</div>
									<div class="clearfix"></div>
								</div>	
							</ul>
 ...
 <div data-vide-bg="video/video" style="position: relative;">
 	<div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;">
 		<video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; width: 1521px; height: auto;">
 			<source src="{{'fontend/assets'}}/video/video.mp4" type="video/mp4">
 			<source src="{{'fontend/assets'}}/video/video.webm" type="video/webm">
 			<source src="{{'fontend/assets'}}/video/video.ogv" type="video/ogg"></video>
 	</div>
    <div class="container">
