...
<div class="banner-top">
	<div class="container">
		<h3 >Lorem</h3>
		<h4><a href="{{'/'}}">Home</a><label>/</label>Lorem</h4>
...
<div id="picture-frame">
			<img src="{{'fontend/assets'}}/images/si.jpg" data-src="{{'fontend/assets'}}/images/si-1.jpg" alt="" class="img-responsive"/>
		</div>
		<script src="{{asset('fontend/assets/js/jquery.zoomtoo.js')}}"></script>
								<script>
			$(function() {
			...
			<div class=" con-w3l wthree-of">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Lays</a>(100 g)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Kurkure</a>(100 g)</h6>							
							</div>
							<div class="mid-2">
								<p ><label>$1.00</label><em class="item_price">$0.70</em></p>
								  <div class="block">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Popcorn</a>(250 g)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}"> Nuts</a>(250 g)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					...
					<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Banana</a>(6 pcs)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Onion</a>(1 kg)</h6>							
							</div>
							<div class="mid-2">
								<p ><label>$1.00</label><em class="item_price">$0.70</em></p>
								  <div class="block">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}"> Bitter Gourd</a>(1 kg)</h6>							
							</div>
							<div class="mid-2">
								<p ><label>$2.00</label><em class="item_price">$1.00</em></p>
								  <div class="block">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Apples</a>(1 kg)</h6>							
							</div>
							<div class="mid-2">
								<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
								  <div class="block">
				...
				<div class="col-md-3 pro-1">
					...
					<a href="#" data-toggle="modal" data-target="#myModal13" class="offer-img">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Honey</a>(500g)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Chocos</a>(250g)</h6>							
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Oats</a>(1 kg)</h6>							
							</div>
							<div class="mid-2">
								<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
								  <div class="block">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="{{'product-details'}}">Bread</a>(500 g)</h6>							
							</div>
							<div class="mid-2">
